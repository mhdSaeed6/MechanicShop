...
public class AppDbContext(DbContextOptions<AppDbContext> options, IMediator mediator) : IdentityDbContext<AppUser>(options), IAppDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Ignore<DomainEvent>(); // اذا ما حطيت Not Mapped بتضرب error لانه ال EF Core بيفكرها Navigation Prop قام بيجي ليساويلها جدول قام ما بيلاقي PK قام بيضرب Error 
