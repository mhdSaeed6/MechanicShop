...
{
    private readonly ValidationBehviour<CreateWorkOrderCommand, Result<WorkOrderDto>> _validationBehavior;
    ...
    public async Task InvokeValidationBehavior_WhenNoValidator_ShouldInvokeNextBehavior()
    {
        // Arrange
        var createWorkOrderCommand = WorkOrderCommandFactory.CreateCreateWorkOrderCommand();
        var validationBehavior = new ValidationBehviour<CreateWorkOrderCommand, Result<WorkOrderDto>>();
